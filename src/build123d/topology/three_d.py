    ...
    def chamfer(
        ...
        for native_edge in native_edges:
            ...
            edge_face_distance_tuples.append(
                (native_edge, TopoDS.Face(topo_face), distance1, distance2)
            )
...
class Solid(Mixin3D[TopoDS_Solid]):
    ...
    def make_box(
        ...
        Returns:
            Solid: Box
        """
        return cls(TopoDS.Solid(ocp_box(plane.to_gp_ax2(), length, width, height)))
    ...
    def draft(self, faces: Iterable[Face], neutral_plane: Plane, angle: float) -> Solid:
        ...
        return Solid(TopoDS.Solid(drafted_shape))
